...
def ask_ai(prompt, system_prompt="You are a helpful, friendly assistant."):
    ...
    if not (base_url and api_key):
        return (
            ...
            "4. Replit may ask for your phone number — that's normal, do it once\n"
            "5. Hit Run again once Agent says it's done\n\n"
            "Still stuck after that? The keys sometimes don't save on the first\n"
            "try. Tell the Agent (the exact variable names matter):\n"
